...
@Component({
  selector: 'app-post-list-artesania',
  templateUrl: './post-list-artesania.component.html',
  styleUrls: ['./post-list-artesania.component.css'],
  animations: [
...
export class PostListArtesaniaComponent implements OnInit {
 ...
 LoadMorePosts(id_cat, numero){
  ...
  ngOnInit() {
    ...
    this.getCategoryCountArtesanoias();
  }
