...
@Component({
  selector: 'app-post-list-gastronomia',
  templateUrl: './post-list-gastronomia.component.html',
  styleUrls: ['./post-list-gastronomia.component.css'],
   animations: [
...
export class PostListGastronomiaComponent implements OnInit {
 ...
 LoadMorePosts(id_cat, numero){
  ...
  ngOnInit() {
    ...
    this.getCategoryCountGatronomia();
  }
