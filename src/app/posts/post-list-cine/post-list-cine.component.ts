...
@Component({
  selector: 'app-post-list-cine',
  templateUrl: './post-list-cine.component.html',
  styleUrls: ['./post-list-cine.component.css'],
  animations: [
...
export class PostListCineComponent implements OnInit {
