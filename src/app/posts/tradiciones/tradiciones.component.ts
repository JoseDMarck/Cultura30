...
@Component({
  selector: 'app-tradiciones',
  templateUrl: './tradiciones.component.html',
  styleUrls: ['./tradiciones.component.css'],
  animations: [
...
export class TradicionesComponent implements OnInit {
...
// CATEGORIAS COUNT SERVICE
 ...
 LoadMorePosts(id_cat, numero){
  ...
  ngOnInit() {
    ...
    this.getCategoryCountTradiciones();
