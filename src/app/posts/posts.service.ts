...
export class PostsService {
  ...
  // POST PARA MUSICA 
  getPosts_artes(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=25&per_page=12&order=desc')
      .map((res: Response) => res.json());
  }
  ...
  // POST PARA artes 
  getPosts_artes_home(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=25&per_page=6&order=desc')
      .map((res: Response) => res.json());
  }
  ...
  GetCategoryCountArtes(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'categories/25')
      .map((res: Response) => res.json());
  }
  ...
  getPosts_videos(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=495&per_page=12&order=desc')
      .map((res: Response) => res.json());
  }

  // POST PARA videos 
  getPosts_videos_home(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=495&per_page=6&order=desc')
      .map((res: Response) => res.json());
  }

  //videos
  GetCategoryCountVideos(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'categories/495')
      .map((res: Response) => res.json());
  }
  ...
  // POST PARA vinos 
  getPosts_vinos(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=496&per_page=12&order=desc')
      .map((res: Response) => res.json());
  }

  // POST PARA vinos 
  getPosts_vinos_home(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=496&per_page=6&order=desc')
      .map((res: Response) => res.json());
  }

  //vinos
  GetCategoryCountVinos(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'categories/496')
      .map((res: Response) => res.json());
  }
  ...
  // POST PARA cultura 
  getPosts_cultura(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=494&per_page=12&order=desc')
      .map((res: Response) => res.json());
  }

  // POST PARA vinos 
  getPosts_cultura_home(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'posts?categories=494&per_page=6&order=desc')
      .map((res: Response) => res.json());
  }

  //vinos
  GetCategoryCountCultura(): Observable<Post[]> {
    return this.http
      .get(this.postsUrl + 'categories/494')
      .map((res: Response) => res.json());
  }
