(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('rxjs/Observable'), require('rxjs/add/observable/of'), require('rxjs/add/observable/fromPromise')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', 'rxjs/Observable', 'rxjs/add/observable/of', 'rxjs/add/observable/fromPromise'], factory) :
	(factory((global.ngxMeta = global.ngxMeta || {}, global.ngxMeta.core = global.ngxMeta.core || {}),global.ng.core,global.ng.platformBrowser,global.Rx.Observable));
}(this, (function (exports,_angular_core,_angular_platformBrowser,rxjs_Observable) { 'use strict';
...
var MetaLoader = (function () {
    ...
    MetaLoader.prototype.settings = function () { };
    return MetaLoader;
}());
...
var MetaService = (function () {
    ...
    MetaService.prototype.setTag = function (key, value) {
        ...
        var value$ = (key !== 'og:locale' && key !== 'og:locale:alternate')
            ? this.callback(value)
            : rxjs_Observable.Observable.of(value);
        value$
            .subscribe(function (res) {
        ...
        if (this.settings.callback) {
            ...
            if (!isObservable(value$))
                return isPromise(value$)
                    ? rxjs_Observable.Observable.fromPromise(value$)
                    : rxjs_Observable.Observable.of(value$);
            return value$;
        }
    ...
    MetaService.ctorParameters = function () { return [
        ...
        { type: _angular_platformBrowser.Meta, },
    ]; };
    return MetaService;
}());
...
var MetaModule = (function () {
    ...
    MetaModule.ctorParameters = function () { return [
        { type: MetaModule, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.SkipSelf },] },
    ]; };
    return MetaModule;
}());
...
exports.PageTitlePositioning = PageTitlePositioning;
